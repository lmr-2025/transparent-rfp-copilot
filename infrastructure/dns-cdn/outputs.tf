...
output "setup_instructions" {
  ...
  value = var.create_hosted_zone ? <<-EOT
    ...
    1. Update your domain registrar with these name servers:
    ...
    4. Update NEXTAUTH_URL in your application:
       NEXTAUTH_URL=https://${var.domain_name}

    ${var.enable_cloudfront ? "5. Test CloudFront distribution:\n       https://${aws_cloudfront_distribution.main[0].domain_name}\n" : ""}
    ========================================
  EOT
  : <<-EOT
    ========================================
    ...
    2. Update NEXTAUTH_URL in your application:
       NEXTAUTH_URL=https://${var.domain_name}

    ${var.enable_cloudfront ? "3. Test CloudFront distribution:\n       https://${aws_cloudfront_distribution.main[0].domain_name}\n" : ""}
    ========================================
  EOT
}
