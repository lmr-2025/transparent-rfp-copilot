# Outputs for Production US Security Environment
...
output "app_s3_policy_arn" {
  ...
  value       = module.s3_policies.app_s3_policy_arn
}
...
output "redis_secret_arn" {
  ...
  value       = var.enable_elasticache_redis ? module.secrets_manager.redis_secret_arn : null
  sensitive   = true
}
...
output "critical_sns_topic_arn" {
  ...
  value       = var.enable_monitoring ? (length(module.monitoring) > 0 ? module.monitoring[0].critical_sns_topic_arn : null) : null
}

output "warning_sns_topic_arn" {
  description = "ARN of the warning alerts SNS topic"
  value       = var.enable_monitoring ? (length(module.monitoring) > 0 ? module.monitoring[0].warning_sns_topic_arn : null) : null
}
