...
LOG_GROUP="/aws/rds/instance/transparent-rfp-db-production/postgresql"
...
**Alert**: `transparent-rfp-db-production-high-connections`
...
**Alert**: `transparent-rfp-db-production-high-cpu`
...
# Test connection
psql "postgresql://dbadmin:$NEW_PASSWORD@<endpoint>:5432/rfp_copilot?sslmode=require" -c "SELECT 1;"
```
...
aws ecs update-service \
  --cluster transparent-rfp-cluster-production \
  --service transparent-rfp-service \
...
aws logs tail /aws/ecs/transparent-rfp-copilot --follow
