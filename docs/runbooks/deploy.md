...
|-------------|--------|----------------|-------------|
| Production | `transparent-trust-prod.mcdinternal.io` | `infrastructure/env/prod-us-security` | Manual |
| Development | `transparent-trust-dev.mcdinternal.io` | `infrastructure/env/dev-us-security` | Manual |
...
cd /path/to/transparent-rfp-copilot
...
export DATABASE_URL="postgresql://dbadmin:PASSWORD@transparent-trust-db-production.xxxxx.us-east-1.rds.amazonaws.com:5432/rfp_copilot?sslmode=require"
...
1. [ ] Access application: `https://transparent-trust-prod.mcdinternal.io`
...
```bash
# Via Tailscale
curl -I https://transparent-trust-prod.mcdinternal.io/api/health
...
# Edit: infrastructure/env/prod-us-security/terraform.tfvars
...
curl -I https://transparent-trust-prod.mcdinternal.io

# Test connectivity to RDS (from local machine)
psql "postgresql://dbadmin:PASSWORD@transparent-trust-db-production.xxxxx.us-east-1.rds.amazonaws.com:5432/rfp_copilot?sslmode=require" -c "SELECT 1;"
```
...
4. Verify DNS resolution: `nslookup transparent-trust-prod.mcdinternal.io`
5. Check Route53 private hosted zone records

See [../infrastructure/env/TAILSCALE_CONFIGURATION.md](../../infrastructure/env/TAILSCALE_CONFIGURATION.md) for detailed setup.
...
- **Linear**: [SEC-1044](https://linear.app/montecarlodata/issue/SEC-1044)
