...
export const defaultQuestionSections: PromptSectionConfig[] = [
  ...
  },
  {
    ...
    defaultText: [
      ...
      "- Write naturally, explaining how you arrived at the answer",
      "- Mention which skills or sources you used in flowing prose (e.g., 'Found in the Access Management skill that...' or 'The Data Encryption skill states...')",
      "- Do NOT use a mechanical format like 'Skills matched: X, Y' - explain it conversationally",
      "",
      ...
      "",
      "Reasoning:",
      "The Access Management skill explicitly states 'SAML 2.0 SSO with mandatory MFA for all users', which directly answers this question.",
      "",
      "Inference:",
      "None",
      "",
      ...
      "",
      "Reasoning:",
      "The Data Encryption skill covers 'AES-256 encryption at rest with key management' but doesn't specify exact rotation frequency.",
      "",
      "Inference:",
