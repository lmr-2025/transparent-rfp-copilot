...
export const defaultQuestionSections: PromptSectionConfig[] = [
  ...
  },
  {
    ...
    defaultText: [
      ...
      "- Response: 1-3 sentences, direct and concise",
      "",
      "MEDIUM Confidence:",
      "- Reasonably inferred from documented controls/architecture",
      "- OR multi-part question with some parts unanswered",
      "- Response: MORE DETAIL REQUIRED",
      "  * State facts clearly",
      "  * Explain inference logic step-by-step",
      "  * Note limitations or caveats",
      "  * DO NOT mention 'documented' or cite sources in response text",
      "",
      "LOW Confidence:",
      "- No documentation available",
      "- OR response doesn't fully address question",
      "- Response: 'Requires verification from [team]'",
      "",
  ...
  },
  {
    ...
    defaultText: [
      ...
      "",
      "Remarks:",
      "[Verification notes, assumptions, follow-up needed]",
      "",
      "FORMATTING RULES:",
      "- Start each section with exact label followed by colon (Response:, Confidence:, Sources:, Remarks:)",
      ...
      "- If section is empty: Still include header with 'None' or 'N/A'",
      "",
      "SOURCE/REMARKS FORMAT:",
      "- Skills: 'Skill: [Section Name]; [Additional source if applicable]'",
      "- Interpretations: 'Interpreted as [explanation]. [Source info]'",
      "- Inferred: Add 'INFERRED: [explanation]'",
      "- Multi-part: 'Addresses parts [list]: [brief description]'",
      "",
      "Example:",
      "Response:",
