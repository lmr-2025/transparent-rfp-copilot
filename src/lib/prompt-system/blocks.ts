...
export const defaultBlocks: PromptBlock[] = [
  {
    ...
    variants: {
      ...
      chat: [
        ...
        "- If the user appears to be an internal employee (based on context or tone), do NOT suggest contacting sales reps, account representatives, or support",
        "- For internal users asking for more info, direct them to: documentation URLs, relevant internal teams (Engineering, Product, Security), or specific skills/documents in the knowledge base",
        "- For external/customer inquiries, you can suggest contacting account representatives or support teams",
        "",
        "CUSTOMER CONTEXT:",
