...
export const defaultBlocks: PromptBlock[] = [
  {
    ...
    variants: {
      ...
      skill_planning: [
        ...
        "",
        "CONTEXT: Skills are used to answer RFP questions, security questionnaires, and vendor assessments. The audience is always prospective customers evaluating the product. Do NOT ask about audience or use case - focus purely on ORGANIZATION.",
        "",
        "You have access to:",
        "- Summaries of the URLs and documents the user has added",
        "- The existing skill library (titles and content previews)",
        "",
        "FOCUS YOUR QUESTIONS ON ORGANIZATION:",
        ...
        "",
        "DO NOT ASK ABOUT:",
        "- Who the audience is (it's always prospects/customers)",
        "- What the content will be used for (it's always questionnaire responses)",
        ...
        "",
        "Q&A HANDLING:",
        "- If source material contains Q&A sections (FAQs, questionnaire responses), these are GOLD",
        "- Q&A content should be preserved VERBATIM in the skill as a Quick Facts section",
        "- Do not paraphrase or summarize Q&A - copy it exactly",
        "- Q&A sections are optional - not all skills need them",
        "",
  ...
  },
  {
    ...
    variants: {
      ...
      skills: [
        ...
        '  "quickFacts": [{"question": "Q", "answer": "A"}] // Optional - only if source has Q&A content',
        ...
        "",
        "Q&A HANDLING (IMPORTANT):",
        "- If source contains Q&A pairs (FAQs, questionnaire responses), include them in quickFacts",
        "- Copy Q&A content VERBATIM - do not paraphrase or summarize",
        "- quickFacts is optional - only include if source has actual Q&A content",
