...
export const defaultBlocks: PromptBlock[] = [
  ...
  },
  {
    ...
    variants: {
      ...
      skills: [
        "Structure each skill with:",
        "",
        "Title: [Clear, specific title]",
        "Content: [The factual information, 2-5 sentences]",
        "Tags: [Relevant categories: encryption, access-control, compliance, etc.]",
      ...
      skill_organize: [
        ...
        '{ "suggestions": [{ "action": "create" | "update", "existingSkillId"?: string, "title": string, "content": string, "tags": string[], "source": string }] }',
        "",
        "For skill merging:",
...
export const defaultCompositions: PromptComposition[] = [
  ...
  {
    context: "chat",
    blockIds: ["role_mission", "source_priority"],
    supportsModes: false,
    supportsDomains: true,
  },
  {
