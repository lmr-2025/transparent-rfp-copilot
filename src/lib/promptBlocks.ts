...
export const defaultBlocks: PromptBlock[] = [
  {
    ...
    variants: {
      ...
      skill_planning: [
        ...
        "",
        "Q&A HANDLING:",
        "- If source material contains Q&A sections (FAQs, questionnaire responses), note this",
        "- Q&A content is valuable and should be preserved in the skill content",
        "- Q&A sections are optional - not all sources have them",
        "",
