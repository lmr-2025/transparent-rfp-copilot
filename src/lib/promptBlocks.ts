  ...
  },
  {
    ...
    variants: {
      ...
      skills: [
        ...
        "- If sources are sparse, keep content brief - do not pad with plausible-sounding details",
        "- When a source only says 'we have X', don't expand it into detailed implementation specifics",
        "- It's better to have a short, accurate skill than a long, hallucinated one",
        "",
        "CONTENT GUIDELINES:",
        "- Use ## headers for each major topic found in sources",
        "- Use bullet points with details directly from sources",
        "- Include facts verbatim when possible: encryption standards, certifications, processes",
        "- If limited info available, say so - don't fabricate comprehensive-looking content",
        "",
        "Q&A HANDLING:",
